...
public class Orders {
	...
	public String toString() {
		return "Orders [orderId=" + orderId + ", custId=" + custId + ", venId=" + venId + ", menuId=" + menuId
				+ ", walSource=" + walSource + ", orderDate=" + orderDate + ", orderQuantity=" + orderQuantity
				+ ", orderBillAmount=" + orderBillAmount + ", orderStatus=" + orderStatus + ", orderComments="
				+ orderComments + "]";
	}
